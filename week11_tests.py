...
class TestWeek10(unittest.TestCase):
    ...
    def test_03_equality(self):
        ...
        self.assertFalse(
            ...
            "== comparison not correct" " when comparing two temperatures",
        )
        self.assertTrue(
        ...
        self.assertFalse(
            temperature == 11,
            "== comparison not correct" " when comparing temperature and number",
        )
        self.assertTrue(
            temperature == 20.5,
            "== comparison not correct" " when comparing temperature and number",
    ...
    def test_05_inequalities(self):
        """Test <= and >=."""
        temperature = Temperature(20.5)
        self.assertTrue(temperature >= 10, ">= comparison not correct")
        self.assertFalse(temperature <= 10, "<= comparison not correct")

        self.assertTrue(temperature <= 20.5, "<= comparison not correct")

        self.assertTrue(10 <= temperature, "<= comparison not correct")

        self.assertFalse(10 >= temperature, ">= comparison not correct")

        self.assertTrue(20.5 >= temperature, ">= comparison not correct")

        self.assertTrue(temperature >= Temperature(4), ">= comparison not correct")

    def test_06_addition(self):
        """Test +."""
        temperature = Temperature(20.5)
        self.assertEqual((5 + temperature).celsius, 25.5, "+ not correct")
        self.assertEqual((temperature + 5).celsius, 25.5, "+ not correct")
        self.assertEqual((temperature + temperature).celsius, 41, "+ not correct")

    def test_07_subtraction(self):
        """Test -."""
        temperature = Temperature(20.5)
        self.assertEqual((temperature - 5).celsius, 15.5, "- not correct")
        self.assertEqual((5 - temperature).celsius, -15.5, "- not correct")
        self.assertEqual((temperature - temperature).celsius, 0, "- not correct")
    ...
    def test_08_inplace_addition(self):
        ...
        backup = temperature
        temperature += 5
        self.assertEqual(temperature.celsius, 25.5, "+= not correct")
        self.assertEqual(backup.celsius, 25.5, "+= not correct")
        temperature += Temperature(5)
        self.assertEqual(temperature.celsius, 30.5, "+= not correct")
        self.assertEqual(backup.celsius, 30.5, "+= not correct")
    ...
    def test_09_inplace_subtraction(self):
        ...
        backup = temperature
        temperature -= 5
        self.assertEqual(temperature.celsius, 15.5, "-= not correct")
        self.assertEqual(backup.celsius, 15.5, "-= not correct")
        temperature -= Temperature(5)
        self.assertEqual(temperature.celsius, 10.5, "-= not correct")
        self.assertEqual(backup.celsius, 10.5, "-= not correct")

    def test_10_hash(self):
        """Test hash."""
        self.assertEqual(
            hash(Temperature(20.5)), hash(Temperature(20.5)), "hash not correct"
        )
        self.assertNotEqual(
            hash(Temperature(20.5)), hash(Temperature(10.5)), "hash not correct"
        )
...
"""
    ...
    def check_header(self, module):
        ...
        for check in [
            ...
            self.assertIn(
                check, docstring, "Missing '{}' in {}'s docstring".format(check, module)
            )
